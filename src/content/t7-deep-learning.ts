  ...
  lessons: [
    /* ====================================================================== */
    {
        ...
        },
        {
          ...
          questions: [
            ...
            },
            {
              ...
              answer: true,
              why: 'Đúng hoàn toàn — cùng công thức, cùng hàm mất mát, cùng nghiệm tối ưu. Khác biệt duy nhất là cách tìm nghiệm: scikit-learn dùng bộ giải tối ưu bậc hai (lbfgs), PyTorch dùng hạ gradient theo lô. Ghi nhớ điều này giúp bạn có một đường cơ sở miễn phí: nếu mạng sâu của bạn không vượt được `LogisticRegression()`, mọi lớp bạn thêm vào đang không đóng góp gì.',
            },
          ],
        },
      ...
      quiz: [
        ...
        },
        {
          ...
          kind: 'truefalse',
          tags: ['mang-noron', 'xor'],
          q: 'Định lý xấp xỉ phổ quát bảo đảm rằng nếu bạn có một mạng một lớp ẩn đủ rộng, hạ gradient sẽ tìm được nghiệm tốt.',
          answer: false,
          why: 'Định lý chỉ nói nghiệm **tồn tại**, không nói bạn **tìm được** nó. Ba khoảng cách nó bỏ ngỏ: số nơ-ron cần có thể tăng theo hàm mũ; hạ gradient không được bảo đảm hội tụ tới nghiệm đó; và bạn cần đủ dữ liệu để phân biệt nghiệm đúng với vô số nghiệm khớp dữ liệu huấn luyện. Nhầm "tồn tại" với "học được" là sai lầm phổ biến khi đọc kết quả lý thuyết.',
        },
      ],
    ...
    /* ====================================================================== */
    {
      ...
      blocks: [
        ...
        { t: 'figure', id: 'fig-gradient-descent', caption: 'Hạ gradient trên mặt lỗi. Tốc độ học quyết định độ dài mỗi bước: quá nhỏ thì bò cả tuần, quá lớn thì bật qua bật lại hai bên thung lũng và không bao giờ xuống đáy.' },
          ...
          questions: [
            {
              ...
              distractorWhy: [
                'Một ensemble cây tăng cường có thể có nhiều tham số hơn MLP; số lượng không phải nguyên nhân.',
                '',
            ...
            },
            {
              ...
              q: 'Mô hình cây tăng cường miễn nhiễm với tấn công đối kháng vì không có gradient để kẻ tấn công khai thác.',
              answer: false,
