        ...
        },
        {
          ...
          steps: [
            ...
            },
            {
              ...
              md: 'Họ đi ngược lại: bắt đầu từ một **tập phép biến đổi bảo toàn chức năng** đã biết là hợp lệ, rồi tìm tổ hợp nào hạ điểm nhiều nhất. Đây là tìm kiếm rời rạc trên một danh sách hành động, không phải gradient descent liên tục. Chậm hơn về lý thuyết, nhưng luôn cho ra tệp chạy được — mà đó mới là thứ họ cần.',
            },
          ],
        },
        {
...
print(xep_hang[:5])   # 5 đặc trưng mong manh nhất`,
      ...
      keyTakeaways: [
        'Sinh mẫu đối kháng là gradient descent chạy ngược: cố định trọng số, sửa đầu vào theo hướng làm TĂNG mất mát.',
      ...
      further: [
        {
          ...
          note: 'Bài giới thiệu FGSM. Đọc để thấy mẫu đối kháng chỉ là gradient descent chạy ngược, không có gì huyền bí.',
        },
        {
      ...
      quiz: [
        {
          ...
          options: [
            ...
            'Thay đổi kiến trúc mô hình từ gradient boosting sang mạng nơ-ron',
          ],
          answer: 1,
    ...
    /* ====================================================================== */
    {
      ...
      further: [
        ...
        },
        {
          ...
          note: 'Áp cho phần hệ thống dùng mô hình ngôn ngữ. Đọc trước khi đánh giá bất kỳ ứng dụng LLM hay agent nào — chặng 9 sẽ đi sâu vào nhóm rủi ro này.',
