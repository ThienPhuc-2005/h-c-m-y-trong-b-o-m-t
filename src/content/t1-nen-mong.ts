    ...
    /* ====================================================================== */
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          id: 'fig-masking',
          caption:
            'Cùng một cột dữ liệu, hai bộ thước đo. Hàng trên: giá trị ngoại lai kéo cả trung bình lẫn độ lệch chuẩn đi theo mình, nên ngưỡng 3-sigma trôi qua bên phải nó và nó thoát. Hàng dưới: trung vị và MAD không nhúc nhích vì một điểm, ngưỡng đứng yên và bắt được. Đó là toàn bộ lý do bài này tồn tại.',
        },
        {
          t: 'callout',
          kind: 'math',
