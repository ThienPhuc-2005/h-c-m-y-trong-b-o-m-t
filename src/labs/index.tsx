...
import { LabEntropy, LabUrlFeatures, LabPeFeatures, LabTfidf, LabAnomaly, LabDrift, LabSeasonality, LabAuthGraph, LabSplit, LabEntity, LabLabels } from './security';
...
export const LABS: LabMeta[] = [
  ...
  { id: 'lab-labels', title: 'Ngưỡng nhãn và cửa sổ chín muồi', blurb: 'Ngưỡng 1 engine bắt cả phần mềm lành, ngưỡng 20 chỉ còn mã độc đã cũ.', track: 'du-lieu', icon: 'flag', Component: LabLabels },
